            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return RecipeCard(
                  ...
                  imageUrl: AssetImage(recipes[index]['imageUrl']! as String),
                  calories: recipes[index]['calories']! as String,
                  cookTime: recipes[index]['cookTime']! as String,
                  cuisine: recipes[index]['cuisine']! as String,
                  ingredients: recipes[index]['ingredients']! as List<String>,
                  instructions: recipes[index]['instructions']! as List<String>,
                );
              },
            ),
          ),
